...
public static class GameStateUtilities
{
    ...
    public static int RemoveAllSoldiers(int gameIndex)
    {
        ...
        int numberOfProtectedPieces = SanctuaryAction.ProtectedBySanctuary(protectedpieces, gameIndex);
        ...
        for (int pid = bm.pieceCount - 1; pid >= 0; pid--)
        {
            ...
            if (isBuilding || SanctuaryAction.IsPieceApartOfSpan(pid, protectedpieces, numberOfProtectedPieces)) continue;

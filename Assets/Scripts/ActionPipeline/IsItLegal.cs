...
//                     for (int i = 0; i < cost.Length && valid < need; i++)
//                     {
//                         int pid = cost[i];
//                         if (!bm.IsValidPieceId(pid)) continue;
//                         if (bm.GetPieceOwner(pid) != player) continue;
//                         if (!seen.Add(pid)) continue; // skip duplicates
//                         valid++;
//                     }
//                     if (valid < need)
//                     {
...
//     public static bool newIsStillLegal(in Game.Core.Action theAction, byte player, int gameIndex)
//     {
//         var gameState = GameRegistry.game[gameIndex].gameState;
//         var controller = GameRegistry.game[gameIndex].gameController;
//         var bm = GameRegistry.game[gameIndex].boardModel;
...
//             case Create:
//                 return CreateAction.IsLegal();

//             case EndRoundTotalsPlayer.PlayerThree:
//                 return 2;

//             case EndRoundTotalsPlayer.PlayerFour:
//                 return 3;

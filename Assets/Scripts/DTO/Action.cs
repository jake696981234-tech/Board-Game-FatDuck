...
namespace Game.Core
{
    ...
    public struct Action
    {
        ...
        public Action(int kind, int ActorsCell, int TargetCell = -1, int TargetType = -1, ushort WallConfig = 0, int intakeCell = -1)
        {
            this.kind = kind;
    ...
    public static class ActionKind
    {
        ...
        public const byte Hop = 15;
        public const byte Create = 16;
        public const byte EndTurn = 17;
    }
}
